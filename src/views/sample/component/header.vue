<template>
  <header id="header">
    <h1>API</h1>
    <button class="tbtn_l tbtn_prev" v-back>이전</button>
    <!-- <router-link :to="-1" replace tag="button" class="tbtn_l tbtn_prev">이전</router-link> -->
    <p class="tbtn_r">
      <router-link :to="'/home'" tag="button" class="tbtn_home">홈</router-link>
